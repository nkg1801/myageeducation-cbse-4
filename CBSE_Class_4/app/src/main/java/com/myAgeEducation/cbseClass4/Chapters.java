...
//					seekBarChaptersFrom.setProgress(0);
	...
	{
		return selectedChapters.size() > 0;
	}
			...
			public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
				...
				mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
					...
					public void onAdDismissedFullScreenContent() {
						...
						Log.d("ADMOB_TEST", "Ad impression");
	...
	private void showInterstitialAdAd()
	{
		...
		{
			Log.d("ADMOB_TEST", "Calling show()");
			mInterstitialAd.show(this);
		}
		else {
			Log.d("ADMOB_TEST", "Interstitial is null");
		}
	}

	public void onClickAdButton(View view)
	{
		//FirebaseManager.updateAdButtonClicked();
		openLink();
	}
